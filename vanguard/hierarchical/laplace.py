...
class LaplaceHierarchicalHyperparameters(BaseHierarchicalHyperparameters):
    ...
    :Example:
        ...
        (True, True)
    """
    def __init__(self, num_mc_samples=100, temperature=None, uv_cutoff=1e-3, **kwargs):
        """
        Initialise self.
    ...
    def _decorate_class(self, cls):
        ...
        class InnerClass(base_decorated_cls):
            def __init__(self, *args, **kwargs):
                ...
                self.hyperparameter_posterior = torch.distributions.MultivariateNormal(loc=mean,
            ...
            def _sgd_round(self, *args, **kwargs):
            ...
            def _compute_hyperparameter_laplace_approximation(self):
            ...
            def _compute_loss_hessian(self):
            ...
            def _update_hyperparameter_posterior(self):
                ...
                laplace_distribution = SpectralRegularisedMultivariateNormal.from_eigendecomposition(mean,
                                                                                                     new_eigenvalues,
                                                                                                     eigenvectors)
    ...
    @staticmethod
    def _infinite_fuzzy_likelihood_samples(controller, x):
...
def _subspace_hessian_inverse_eig(hessian, cutoff=1e-3):
    """
    ...
    Along bad directions, we the the Hessian inverse eigenvalues to a fixed
    small jitter value.
    """
...
def _posterior_to_likelihood_samples(posterior_generator):
    """Convert an infinite posterior sample generator to generate likelihood samples."""
    def generator(controller, x, *args):
        """Yield likelihood samples forever."""
