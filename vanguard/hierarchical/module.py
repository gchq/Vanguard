...
class BayesianHyperparameters:
    ...
    .. note::
        ...
        a subclass of :py:class:`~vanguard.hierarchical.base.BaseHierarchicalHyperparameters`.
    ...
    def __call__(self, module_class: Type[ModuleType]) -> Type[ModuleType]:
...
def _process_hyperparameter(module: Type[ModuleType], raw_parameter_name: str, prior_means: Union[dict, None], prior_variances: Union[dict, None]) -> BayesianHyperparameter:
    """
...
def _discover_modules_and_parameters(top_module: torch.nn.Module, base_modules: Iterable[torch.nn.Module]) -> Tuple[List[str], List[Tuple[Module, str]]]:
    """
...
def _descend_module_tree(top_module: Module, parameter_ancestry: List[str]) -> Tuple[Module, str]:
    """
