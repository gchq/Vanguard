...
the :py:func:`require_controller_input` decorator will allow a warp function to be
...
def require_controller_input(cache_name):
    ...
    .. note::
        The :py:class:`~vanguard.warps.SetWarp` decorator will call :py:meth:`activate` on the user's behalf,
