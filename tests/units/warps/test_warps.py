...
class ForwardTest(unittest.TestCase):
    ...
    def test_affine_log_value(self):
    ...
    def test_positive_affine_log_value(self):
    ...
    def test_affine_non_trivial_log_value(self):
    ...
    def test_affine_log_multitask_value(self):
    ...
    def test_positive_affine_log_value_with_2_dim_y(self):
        box_cox = warpfunctions.BoxCoxWarpFunction(lambda_=0)
        affine = warpfunctions.PositiveAffineWarpFunction()
...
class DerivTest(unittest.TestCase):
    ...
    def test_autograd_log_affine_multitask(self):
...
class PositiveAffineWarpTests(unittest.TestCase):
    ...
    def test_feasible_region_no_points(self):
        """Should raise a ValueError."""
        with self.assertRaises(ValueError):
            warpfunctions.PositiveAffineWarpFunction._get_constraint_slopes(np.array([]))

    @staticmethod
    def _get_points_in_boundary_of_feasible_region(a_b_points, x_values):
