...
class ParameterAgreementTests(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.greedy_controller = GaussianGPController(cls.dataset.train_x, cls.dataset.train_y,
        ...
        cls.controller = GaussianGPController(cls.dataset.train_x, cls.dataset.train_y,
                                              ScaledRBFKernel, cls.dataset.train_y_std,
                                              optimiser_kwargs={"lr": 20}, smart_optimiser_class=SmartOptimiser)

        cls.controller2 = GaussianGPController(cls.dataset.train_x, cls.dataset.train_y,
                                               ScaledRBFKernel, cls.dataset.train_y_std,
                                               optimiser_kwargs={"lr": 20}, smart_optimiser_class=SmartOptimiser)
